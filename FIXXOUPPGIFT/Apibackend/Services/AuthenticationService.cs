...
namespace Apibackend.Services
{
    public class AuthenticationService
    {
        ...
        private readonly UserRepository _profileRepo;

        public AuthenticationService(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, RoleManager<IdentityRole> roleManager, UserRepository profileRepo)
        {
